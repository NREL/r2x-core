...
_LAZY_IMPORTS: dict[str, tuple[str, str | None]] = {
    ...
    "PluginComponent": (".plugins", "PluginComponent"),
    "SystemModifier": (".plugins", "SystemModifier"),
    "FilterFunction": (".plugins", "FilterFunction"),
    "PluginUpgrader": (".upgrader", "PluginUpgrader"),
    # Result types
