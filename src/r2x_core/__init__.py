...
_LAZY_IMPORTS: dict[str, tuple[str, str | None]] = {
    ...
    "InvocationSpec": (".plugin", "InvocationSpec"),
    "ImplementationType": (".plugin", "ImplementationType"),
    "ArgumentSpec": (".plugin", "ArgumentSpec"),
    "ArgumentSource": (".plugin", "ArgumentSource"),
    "IOContract": (".plugin", "IOContract"),
    "IOSlot": (".plugin", "IOSlot"),
    "IOSlotKind": (".plugin", "IOSlotKind"),
    "StoreSpec": (".plugin", "StoreSpec"),
    "StoreMode": (".plugin", "StoreMode"),
    "ConfigSpec": (".plugin", "ConfigSpec"),
    "ResourceSpec": (".plugin", "ResourceSpec"),
    "UpgradeSpec": (".plugin", "UpgradeSpec"),
    "UpgradeStepSpec": (".plugin", "UpgradeStepSpec"),
}
